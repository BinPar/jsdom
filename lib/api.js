...
const domToHtml = domtohtml.domToHtml;
...
class JSDOM {
  constructor(input, options = {}) {
    const normalizedHtml = normalizeHTML(input, options[transportLayerEncodingLabelHiddenOption]);
    const html = normalizedHtml.html;
    const encoding = normalizedHtml.encoding;
